...
> **Current foundation review (2026-09-10):** Consult
> [docs/FOUNDATION_DECISIONS.md](docs/FOUNDATION_DECISIONS.md) and
> [AGENTS.md](AGENTS.md) before acting on this document. Its HGSS plans and
> verification notes describe earlier implementation stages and include stale
> status claims. The final platform is under review; no migration is approved
> by this banner. Preserve the historical evidence while decisions are resolved.
