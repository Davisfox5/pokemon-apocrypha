...
> **Foundation review (2026-09-10):** Read [AGENTS.md](AGENTS.md) and
> [the decision record](docs/FOUNDATION_DECISIONS.md) first. The owner has
> specified AI-driven production and is choosing the final GBA/DS base.
> The DS setup below describes the existing implementation, not a newly
> approved platform decision. No map rendering is part of this review.
