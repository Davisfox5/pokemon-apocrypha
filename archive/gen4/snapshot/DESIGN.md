...
> **Foundation review (2026-09-10):** Story and creative decisions below remain
> authoritative. Platform, production responsibilities, and conflicting mechanic
> scope are being reconciled in [docs/FOUNDATION_DECISIONS.md](docs/FOUNDATION_DECISIONS.md).
> The old DS-only and reuse-only assumptions are not instructions to ignore the
> owner's newer AI-driven production and newly authored map requirements.
