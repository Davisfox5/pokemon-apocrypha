...
| Claude's independent Cherrygrove exterior / playable preview | ../gba/art/claude-cherrygrove/README.md | HGSS-in-2D scenery derived from the HGSS render and DS tree texture, own tilesets, workbench-preset build, `gba/claude-cherrygrove.patch`, runtime, movement and Porymap round-trip evidence |
