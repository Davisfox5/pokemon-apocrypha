...
int main(int argc,char**argv){
 ...
 interaction(1029,47,14,"gold-dialogue");
 interaction(1030,54,16,"silver-dialogue");
 interaction(1031,55,12,"kestra-dialogue");
 interaction(1032,44,11,"hoenn-dialogue");
interaction(1033,47,11,"kanto-dialogue");
interaction(1034,50,11,"johto-dialogue");
interaction(1035,53,11,"sinnoh-dialogue");
interaction(1036,56,11,"unova-dialogue");
 c->deinit(c);return 0;
}
