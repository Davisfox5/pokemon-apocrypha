...
int main(int argc,char**argv){
 ...
 if(!strcmp(argv[4],"menu")){
  ...
  go(0,61,18);frames(64,16);frames(40,0);expect(9,"route29-out");screenshot(argv[3],"route29");frames(80,32);frames(40,0);expect(0,"route29-return");
  ...
  go(0,24,19);frames(32,32);frames(20,0);expect(0,"shore-collision");if(state[3]!=24)return 10;
  go(0,39,17);screenshot(argv[3],"residential-lane");
  go(0,53,25);screenshot(argv[3],"gardens");
  go(0,46,21);screenshot(argv[3],"gold-house");
